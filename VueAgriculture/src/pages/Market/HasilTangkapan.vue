<!-- src/pages/Market/HasilTangkapan.vue -->
<template>
  <div>
...
const items = ref([
  { id: 1, name: 'Ikan Nila', description: 'Ikan nila segar langsung dari laut', category: 'Ikan', image: 'link_gambar_ikan', sellerContact: '628123456789' },
  { id: 2, name: 'Udang Galah', description: 'Udang galah besar dan segar', category: 'Udang', image: 'link_gambar_udang', sellerContact: '628987654321' },
